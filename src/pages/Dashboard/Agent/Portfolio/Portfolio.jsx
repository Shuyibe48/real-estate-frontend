      ...
      <div className="py-4 bg-white xl:px-20 md:px-10 sm:px-2 px-4 flex justify-between items-start">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-2">
            ...
            <p>
              Sales Consultant at{" "}
              <Link className="underline">{user?.myAgency?.agency?.name}</Link>{" "}
            </p>
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-8">
            <div className="space-y-2 my-4 bg-white p-4 rounded-md shadow-md">
              <div>
                <h1 className="font-semibold text-lg">
                  {user?.name?.firstName}'s performance snapshot
                </h1>
            ...
            <div className="space-y-2 my-4 bg-white p-4 rounded-md shadow-md">
              <div>
                <h1 className="font-semibold text-lg">
                  {user?.name?.firstName}'s properties
                </h1>
            ...
            <div className="space-y-2 my-4 bg-white p-4 rounded-md shadow-md">
              <div>
                <h1 className="font-semibold text-lg">
                  {user?.name?.firstName}'s performance
                </h1>
                <p>
            ...
            <div className="space-y-2 my-4 bg-white p-4 rounded-md shadow-md">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>
                    Partnered with {user?.name?.firstName} before?{" "}
              ...
              <div>
                <p className="font-semibold mb-1">
                  Clients say {user?.name?.firstName} is...
                </p>
            ...
            <div
              id="enquiry"
              className="space-y-2 my-4 bg-white rounded-md shadow-md"
            >
              <div>
                {/* Header */}
