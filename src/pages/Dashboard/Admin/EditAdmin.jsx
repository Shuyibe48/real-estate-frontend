...
const EditAdmin = () => {
  ...
  // Update profileImg in formData whenever avatar changes
  useEffect(() => {
    if (avatar.length > 0) {
      setFormData((prevData) => ({
        ...prevData,
        profileImg: avatar[0], // Assuming the first element contains the URL
      }));
    }
  }, [avatar]);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const res = await baseUrl.patch(`/admins/${admin?._id}`, {
        admin: {
          name: {
        ...
        <div className="py-4">
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              <h1 className="font-semibold text-2xl">Moderator Profile</h1>
              {/* Submit Button */}
              {edit ? (
                <button
                  type="submit"
            ...
            <div className="mb-1 space-y-4">
              ...
              <div className="space-y-1 mb-6">
                <label htmlFor="profileImg" className="block font-semibold">
                  Profile Image
                </label>
