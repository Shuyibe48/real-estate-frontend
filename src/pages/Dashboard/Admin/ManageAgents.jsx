...
const ManageAgents = () => {
  ...
  const {
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const { data } = await baseUrl.get(`agents/get-agents`, {
        params: {
          limit: entries,
          page: currentPage,
        },
  ...
  return (
    <div className="mt-8">
      <Container>
        <div className="mb-4">
          <h5 className="text-[1.5rem] font-bold">Manage Agents</h5>
          <p className="text-[#9bbcd1] text-[1rem]">
            Welcome to the Manage Agents Table!
          </p>
        </div>
        <div className="overflow-x-auto min-w-[300px] flex flex-col justify-between mb-4 mt-6 bg-[#FDF8F4] shadow-lg p-6 rounded-lg">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2 md:gap-0">
            <div className="mb-4">
              <h5 className="text-xl font-semibold">All Agents List</h5>
