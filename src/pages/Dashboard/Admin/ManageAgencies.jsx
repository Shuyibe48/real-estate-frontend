...
const ManageAgencies = () => {
  ...
  const {
    ...
    queryKey: ["agencies/get-agencies", entries, currentPage],
    queryFn: async ({ queryKey }) => {
      const [_key, entries, currentPage] = queryKey;
      const { data } = await baseUrl.get(`agencies/get-agencies`, {
        params: {
          limit: entries,
          page: currentPage,
        },
  ...
  return (
    <div className="mt-8">
      <Container>
        <div className="mb-4">
          <h5 className="text-[1.5rem] font-bold">Manage Agencies</h5>
          <p className="text-[#9bbcd1] text-[1rem]">
            Welcome to the Manage Agencies Table!
          </p>
        </div>
        <div className="overflow-x-auto min-w-[300px] flex flex-col justify-between mb-4 mt-6 bg-[#FDF8F4] shadow-lg p-6 rounded-lg">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2 md:gap-0">
            <div className="mb-4">
              <h5 className="text-xl font-semibold">All Agencies List</h5>
